...
void setup()
{
  ...
  {  
    ...
    s = String("AK8963: I AM ") + String(d, HEX) + String(". I should be ") + String(0x48, HEX);
    Serial.println(s);
    ...
    Serial.print(magCalibration[0], 2);
    Serial.print(String(" ASAY ")) ; 
    Serial.print(magCalibration[1], 2);
    Serial.print(String(" ASAZ ")) ; 
    Serial.print(magCalibration[2], 2);
    Serial.println();
    delay(1000);  
  }
  else
...
{  
  ...
  if (!AHRS) {
    ...
    if(delt_t > 500) {
      ...
      Serial.println("MPU9250/AK8963");
      Serial.println("\tx\ty\tz");

      Serial.print(String('\t') + String((int)(1000*ax))); 
      Serial.print(String('\t') + String((int)(1000*ay))); 
      Serial.print(String('\t') + String((int)(1000*az))); 
      Serial.println("\tmg");

      Serial.print(String('\t') + String((int)(gx))); 
      Serial.print(String('\t') + String((int)(gy))); 
      Serial.print(String('\t') + String((int)(gz))); 
      Serial.println("\to/s");    

      Serial.print(String('\t') + String((int)(mx))); 
      Serial.print(String('\t') + String((int)(my))); 
      Serial.print(String('\t') + String((int)(mz))); 
      Serial.print("\tmG");   
    ...
    if (delt_t > 500) { // update LCD once per half-second independent of read rate
      ...
      Serial.print(String('\t') + String((int)(yaw))); 
      Serial.print(String('\t') + String((int)(pitch))); 
      Serial.print(String('\t') + String((int)(roll))); 
      Serial.println("\typr");  
